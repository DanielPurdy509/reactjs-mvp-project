    ...
    return (
        <div className="about_page">
            ...
            <div className="word_block">
                ...
                <p>
                    I wanted to create a space to store my photography from my journeys while also practicing my web development skills. This webpage was created using React for the Front End and Express for the Back End server.
                </p>
                <p>
